...
class LoadMore extends elementorModules.frontend.handlers.Base {
  ...
  handlePostsQuery() {
    ...
    this.currentPage++;
    const restUrl = `${ElementorTenwebFrontendConfig.urls.rest}elementor-pro/v1/posts-widget?post_id=${this.postId}&element_id=${this.elementId}&page=${this.currentPage}`;
...
class TOCHandler extends elementorModules.frontend.handlers.Base {
  ...
  handleNoHeadingsFound() {
    let noHeadingsText = elementorTenwebFrontend.config.i18n.toc_no_headings_found;

    if (elementorFrontend.isEditMode()) {
      noHeadingsText = elementorTenweb.translate('toc_no_headings_found');
    }
...
class _default extends elementorModules.frontend.handlers.Base {
  ...
  bindEvents() {
    const menuCart = elementorTenwebFrontend.config.menu_cart,

...
module.exports = elementorModules.Module.extend({
  ...
  getCustomFont: function getCustomFont(fontType, font) {
    elementorTenweb.ajax.addRequest('assets_manager_panel_action_data', {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function onNavigatorInit() {
      elementor.navigator.indicators.customCSS = {
        ...
        title: elementorTenweb.translate('custom_css'),
...
module.exports = elementorModules.editor.utils.Module.extend({
  ...
  onInit: function onInit() {
    elementor.hooks.addFilter('elementor_tenweb/forms/content_template/field/acceptance', this.renderField, 10, 4);
  }
});

/***/ }),

/***/ "../modules/forms/assets/js/editor/fields/custom_button.js":
/*!**************************************************************!*\
  !*** ../modules/forms/assets/js/editor/fields/custom_button.js ***!
  \**************************************************************/
/***/ ((module) => {
  ...
  module.exports = elementorModules.editor.utils.Module.extend({
    renderField: function renderField(inputField, item, i, settings) {
      ...
      if (item.custom_button_type) {
        type = ' elementor-button-' + item.custom_button_type;
      }

      if (item.custom_button_align) {
        align = ' elementor-align-' + item.custom_button_align;
      }

      if (item.custom_button_url) {
        if (item.custom_button_url.url) {
          href = item.custom_button_url.url;
        }
        else {
          href = item.custom_button_url;
        }
      }
      return '<div class="elementor-button-wrapper elementor-element elementor-field' + type + align + '"><a id="' + item.custom_id + '" class="elementor-button-link elementor-button elementor-size-' + item.custom_button_size + '" href="' + href + '" role="button"><span class="elementor-button-content-wrapper"><span class="elementor-button-text">' + item.custom_button_text + '</span></span></a></div>';
    },
    onInit: function onInit() {
      elementor.hooks.addFilter('elementor_tenweb/forms/content_template/field/custom_button', this.renderField, 10, 4);
    }
  });
...
module.exports = elementorModules.editor.utils.Module.extend({
  ...
  onInit: function onInit() {
    elementor.hooks.addFilter('elementor_tenweb/forms/content_template/field/date', this.renderField, 10, 4);
  }
});
...
module.exports = elementorModules.editor.utils.Module.extend({
  ...
  onInit: function onInit() {
    elementor.hooks.addFilter('elementor_tenweb/forms/content_template/field/tel', this.renderField, 10, 4);
  }
});
...
module.exports = elementorModules.editor.utils.Module.extend({
  ...
  onInit: function onInit() {
    elementor.hooks.addFilter('elementor_tenweb/forms/content_template/field/time', this.renderField, 10, 4);
  }
});
...
module.exports = elementorModules.editor.utils.Module.extend({
  ...
  onInit: function onInit() {
    elementor.hooks.addFilter('elementor_tenweb/forms/content_template/field/upload', this.renderField, 10, 4);
  }
});
...
var FormFieldsSanitizeCustomId = /*#__PURE__*/function (_$e$modules$hookData$) {
  ...
  (0, _createClass2.default)(FormFieldsSanitizeCustomId, [{
    ...
    value: function getId() {
      return 'elementor-tenweb-forms-fields-sanitize-custom-id';
    }
  }, {
...
var FormFieldsSetCustomId = /*#__PURE__*/function (_$e$modules$hookData$) {
  ...
  (0, _createClass2.default)(FormFieldsSetCustomId, [{
    ...
    key: "getId",
    value: function getId() {
      return 'elementor-tenweb-forms-fields-set-custom-id';
    }
  }, {
    key: "getContainerType",
    value: function getContainerType() {
...
var FormFieldsAddFirstStep = /*#__PURE__*/function (_$e$modules$hookData$) {
  ...
  (0, _createClass2.default)(FormFieldsAddFirstStep, [{
    ...
    key: "getId",
    value: function getId() {
      return 'elementor-tenweb-forms-fields-first-step';
    }
  }, {
    key: "getContainerType",
    value: function getContainerType() {
    ...
    value: function getConditions(args) {
      var _args$containers = args.containers,
          containers = _args$containers === void 0 ? [args.container] : _args$containers;
      return 'twbb_form' === containers[0].parent.parent.model.get('widgetType') && 'step' === args.settings.field_type;
    }
  }, {
    key: "apply",
    value: function apply(args) {
...
var FormSanitizeId = /*#__PURE__*/function (_$e$modules$hookData$) {
  ...
  (0, _createClass2.default)(FormSanitizeId, [{
    ...
    key: "getId",
    value: function getId() {
      return 'elementor-tenweb-forms-sanitize-id';
    }
  }, {
    key: "getContainerType",
    value: function getContainerType() {
...
/* 10Web Builder
* This is supposed to sanitize Button CSS ID
* Must be removed when Elementor will do it */
/***/ "../modules/forms/assets/js/editor/hooks/data/form-sanitize-button-id.js":
/*!************************************************************************!*\
  !*** ../modules/forms/assets/js/editor/hooks/data/form-sanitize-button-id.js ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
  ...
  exports.default = exports.FormSanitizeButtonId = void 0;
  ...
  var FormSanitizeButtonId = /*#__PURE__*/function (_$e$modules$hookData$) {
    (0, _inherits2.default)(FormSanitizeButtonId, _$e$modules$hookData$);

    var _super = (0, _createSuper2.default)(FormSanitizeButtonId);

    function FormSanitizeButtonId() {
      var _this;

      (0, _classCallCheck2.default)(this, FormSanitizeButtonId);
    ...
    (0, _createClass2.default)(FormSanitizeButtonId, [{
      key: "getCommand",
      value: function getCommand() {
        return 'document/elements/settings';
      }
      ...
      key: "getId",
      value: function getId() {
        return 'elementor-tenweb-forms-sanitize-button-id';
      }
    }, {
      key: "getContainerType",
      value: function getContainerType() {
      ...
      key: "getConditions",
      value: function getConditions(args) {
        return undefined !== args.settings.button_css_id;
      }
    }, {
      key: "apply",
      value: function apply(args) {
        var container = args.container,
          settings = args.settings;
        var button_css_id = settings.button_css_id; // eslint-disable-line camelcase
        // Re-render with old settings.

        if (button_css_id.match(this.ID_SANITIZE_FILTER)) {
          var formIdView = container.panel.getControlView('button_css_id');
          formIdView.render();
          formIdView.$el.find('input').trigger('focus'); // Hook-Break.
    ...
    return FormSanitizeButtonId;
  }($e.modules.hookData.Dependency);

  exports.FormSanitizeButtonId = FormSanitizeButtonId;
  var _default = FormSanitizeButtonId;
  exports.default = _default;
...
* This is supposed to sanitize Button CSS ID
* Must be removed when Elementor will do it */
_Object$defineProperty(exports, "FormSanitizeButtonId", {
  enumerable: true,
  get: function get() {
    return _formSanitizeButtonId.FormSanitizeButtonId;
  }
});
...
* This is supposed to sanitize Button CSS ID
* Must be removed when Elementor will do it */
var _formSanitizeButtonId = __webpack_require__(/*! ./form-sanitize-id */ "../modules/forms/assets/js/editor/hooks/data/form-sanitize-button-id.js");
...
var FormFieldsUpdateShortCode = /*#__PURE__*/function (_$e$modules$hookUI$Af) {
  ...
  (0, _createClass2.default)(FormFieldsUpdateShortCode, [{
    ...
    key: "getId",
    value: function getId() {
      return 'elementor-tenweb-forms-fields-update-shortcode';
    }
  }, {
    key: "getContainerType",
    value: function getContainerType() {
...
module.exports = ElementEditorModule.extend({
  ...
  fetchCache: function fetchCache(type, cacheKey, requestArgs) {
    ...
    return elementorTenweb.ajax.addRequest('forms_panel_action_data', {
...
var FormsModule = /*#__PURE__*/function (_elementorModules$edi) {
  ...
  (0, _createClass2.default)(FormsModule, [{
    ...
    value: function onElementorInit() {
      ...
      this.mailchimp = new Mailchimp('twbb_form');
      this.recaptcha = new Recaptcha('twbb_form');
      this.drip = new Drip('twbb_form');
      this.activecampaign = new ActiveCampaign('twbb_form');
      this.getresponse = new GetResponse('twbb_form');
      this.convertkit = new ConvertKit('twbb_form');
      this.mailerlite = new MailerLite('twbb_form'); // Form fields
      ...
      var TimeField = __webpack_require__(/*! ./fields/time */ "../modules/forms/assets/js/editor/fields/time.js"),
          ...
          CustomButtonField = __webpack_require__(/*! ./fields/custom_button */ "../modules/forms/assets/js/editor/fields/custom_button.js"),
      ...
      this.Fields = {
        time: new TimeField('twbb_form'),
        date: new DateField('twbb_form'),
        tel: new TelField('twbb_form'),
        acceptance: new AcceptanceField('twbb_form'),
        custom_button: new CustomButtonField('twbb_form'),
        upload: new UploadField('twbb_form')
      };
...
module.exports = elementorModules.editor.utils.Module.extend({
  ...
  getDataSettings: function getDataSettings(item) {
    var config = elementorTenweb.config.forms[item.field_type],
  ...
  onInit: function onInit() {
    elementor.hooks.addFilter('elementor_tenweb/forms/content_template/item', this.filterItem);
    elementor.hooks.addFilter('elementor_tenweb/forms/content_template/field/recaptcha', this.renderField, 10, 2);
    elementor.hooks.addFilter('elementor_tenweb/forms/content_template/field/recaptcha_v3', this.renderField, 10, 2);
  }
});
...
module.exports = function () {
  ...
  var updateReplyToOptions = function updateReplyToOptions() {
    ...
    emailFields = _.map(emailModels, function (model) {
      return {
        ...
        label: elementorTenweb.translate('x_field', [model.get('field_label')])
      };
    });
  ...
  var init = function init() {
    elementor.hooks.addAction('panel/open_editor/widget/twbb_form', onPanelShow);
  };
  ...
  (0, _createClass2.default)(Link, [{
    ...
    value: function getHistory(args) {
      ...
      return {
        ...
        subTitle: data.title,
        type: elementorTenweb.translate('linked_to_global')
      };
    }
  }, {
    key: "apply",
    value: function apply(args) {
      ...
      container) {
        ...
        var globalModel = elementorTenweb.modules.globalWidget.addGlobalWidget(data.template_id, data),
  ...
  (0, _createClass2.default)(Unlink, [{
    ...
    value: function getHistory(args) {
      ...
      return {
        ...
        type: elementorTenweb.translate('unlink_widget')
      };
    }
  }, {
    key: "apply",
    value: function apply(args) {
      ...
      /** Container */
      container) {
        var globalModel = elementorTenweb.modules.globalWidget.getGlobalModels(container.model.get('templateID'));
        $e.run('document/elements/create', {
          container: container.parent,
          model: {
            id: elementorCommon.helpers.getUniqueId(),
...
var GlobalWidgetSave = /*#__PURE__*/function (_$e$modules$hookData$) {
  ...
  (0, _createClass2.default)(GlobalWidgetSave, [{
    ...
    value: function apply() {
      elementorTenweb.modules.globalWidget.saveTemplates();
    }
  }]);
  ...
  (0, _createClass2.default)(Module, [{
    ...
    value: function registerTemplateType() {
      elementor.templates.registerTemplateType('widget', {
        showInLibrary: false,
        saveDialog: {
          title: elementorTenweb.translate('global_widget_save_title'),
          description: elementorTenweb.translate('global_widget_save_description')
        },
    ...
    value: function addSavedWidgetsToPanel() {
      ...
      _.each(elementorTenweb.config.widget_templates, function (templateArgs, id) {
...
module.exports = Marionette.ItemView.extend({
  ...
  buildUnlinkDialog: function buildUnlinkDialog() {
    ...
    return elementorCommon.dialogsManager.createWidget('confirm', {
      ...
      headerMessage: elementorTenweb.translate('unlink_widget'),
      message: elementorTenweb.translate('dialog_confirm_unlink'),
      position: {
        my: 'center center',
        at: 'center center'
      },
      strings: {
        confirm: elementorTenweb.translate('unlink'),
        cancel: elementorTenweb.translate('cancel')
      },
  ...
  onEditButtonClick: function onEditButtonClick() {
    ...
    elementorTenweb.modules.globalWidget.requestGlobalModelSettings(editedModel, function () {
...
module.exports = elementor.modules.elements.models.Element.extend({
  ...
  getGlobalModel: function getGlobalModel() {
    ...
    return elementorTenweb.modules.globalWidget.getGlobalModels(templateID);
  },
  getTitle: function getTitle() {
    ...
    var global = elementorTenweb.translate('global');
...
GlobalWidgetView = WidgetView.extend({
  ...
  initialize: function initialize() {
    ...
    if (previewSettings) {
      ...
      if (!globalSettingsLoadedStatus) {
        ...
        elementorTenweb.modules.globalWidget.requestGlobalModelSettings(globalModel, null, this.getContainer());
      }
  ...
  getGlobalModel: function getGlobalModel() {
    if (!this.globalModel) {
      this.globalModel = elementorTenweb.modules.globalWidget.getGlobalModels(this.model.get('templateID'));
    }
...
module.exports = function () {
  ...
  self.onTemplateIdChange = function () {
    ...
    var editUrl = elementorTenwebEditorConfig.home_url + '?p=' + templateID + '&elementor';
    ...
    if ($editButton.length) {
      ...
      $editButton = jQuery('<a />', {
        ...
        href: editUrl,
        html: '<i class="eicon-pencil" /> ' + elementorTenweb.config.i18n.edit_template
      });
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function onNavigatorInit() {
      elementor.navigator.indicators.motionFX = {
        icon: 'flash',
        title: elementorTenweb.translate('motion_effects'),
      ...
      this.children.each(function (child) {
        ...
        var $imageWrapper = jQuery('<div>', {
          class: 'elementor-popup__display-settings_controls_group__icon'
            ...
            $image = jQuery('<img>', {
          src: elementorTenweb.config.urls.modules + "popup/assets/images/".concat(name, "/").concat(groupName, ".svg")
        });
...
var PopupSave = /*#__PURE__*/function (_$e$modules$hookData$) {
  ...
  (0, _createClass2.default)(PopupSave, [{
    ...
    value: function apply() {
      var settings = {};
      jQuery.each(elementorTenweb.modules.popup.displaySettingsTypes, function (type, data) {
        settings[type] = data.model.toJSON({
          remove: ['default']
        });
      });
      elementorTenweb.ajax.addRequest('popup_save_display_settings', {
        data: {
          settings: settings
        }
      });
...
var PopupRemoveTriggers = /*#__PURE__*/function (_$e$modules$hookUI$Af) {
  ...
  (0, _createClass2.default)(PopupRemoveTriggers, [{
    ...
    value: function removePanelFooterSubmenuItems() {
      var displaySettingsTypes = elementorTenweb.modules.popup.displaySettingsTypes;
    ...
    value: function removePublishTabs() {
      var component = $e.components.get('theme-builder-publish'),
          displaySettingsTypes = elementorTenweb.modules.popup.displaySettingsTypes;
      jQuery.each(displaySettingsTypes, function (type) {
    ...
    value: function getIntroduction() {
      return new elementorModules.editor.utils.Introduction({
        ...
        dialogOptions: {
          ...
          headerMessage: '<i class="eicon-info"></i>' + elementorTenweb.translate('popup_settings_introduction_title'),
          message: elementorTenweb.translate('popup_settings_introduction_message'),
          closeButton: true,
  ...
  (0, _createClass2.default)(PopupAddLibraryTab, [{
    ...
    value: function apply() {
      $e.components.get('library').addTab('templates/popups', {
        title: elementorTenweb.translate('popups'),
        filter: {
          source: 'remote',
          type: 'popup'
        }
  ...
  (0, _createClass2.default)(PopupAddTriggers, [{
    ...
    value: function addPublishTabs() {
      var config = elementor.config.document.displaySettings,
          ...
          module = elementorTenweb.modules.popup;
      jQuery.each(module.displaySettingsTypes, function (type, data) {
        ...
        component.addTab(type, {
          ...
          name: type,
          title: elementorTenweb.translate(type),
          description: elementorTenweb.translate("popup_publish_screen_".concat(type, "_description")),
          image: elementorTenweb.config.urls.modules + "popup/assets/images/".concat(type, "-tab.svg")
        });
      });
    }
  }, {
...
module.exports = elementor.modules.controls.Select2.extend({
  ...
  getSelect2Placeholder: function getSelect2Placeholder() {
    return {
      id: '',
      text: elementorTenweb.translate('all')
    };
  },
    ...
    return jQuery.extend(elementor.modules.controls.Select2.prototype.getSelect2DefaultOptions.apply(this, arguments), {
      ajax: {
        transport: function transport(params, success, failure) {
          ...
          return elementorTenweb.ajax.addRequest(action, {
            data: data,
            success: success,
            error: failure
          });
...
module.exports = elementorModules.editor.utils.Module.extend({
  config: elementorTenweb.config.shareButtonsNetworks,
...
module.exports = elementor.modules.controls.RepeaterRow.extend({
  ...
  checkConflicts: function checkConflicts() {
    ...
    $error.remove();
    elementorTenweb.ajax.addRequest('theme_builder_conditions_check_conflicts', {
      unique_id: rowId,
      data: {
...
module.exports = elementor.modules.controls.Repeater.extend({
  ...
  onRender: function onRender() {
    this.ui.btnAddRow.text(elementorTenweb.translate('add_condition'));
  }
});
...
var ThemeBuilderUpdatePreviewOptions = /*#__PURE__*/function (_$e$modules$hookData$) {
  ...
  (0, _createClass2.default)(ThemeBuilderUpdatePreviewOptions, [{
    ...
    value: function apply(args) {
      var _args$containers = args.containers,
          containers = _args$containers === void 0 ? [args.container] : _args$containers,
          themeBuilder = elementorTenweb.modules.themeBuilder;
      $e.run('document/elements/settings', {
...
var ThemeBuilderSaveConditions = /*#__PURE__*/function (_$e$modules$hookData$) {
  ...
  (0, _createClass2.default)(ThemeBuilderSaveConditions, [{
    ...
    key: "apply",
    value: function apply() {
      var conditionsModel = elementorTenweb.modules.themeBuilder.conditionsModel;
      elementorTenweb.ajax.addRequest('theme_builder_save_conditions', {
...
var ThemeBuilderToggleMenuConditions = /*#__PURE__*/function (_$e$modules$hookUI$Af) {
  ...
  (0, _createClass2.default)(ThemeBuilderToggleMenuConditions, [{
    ...
    key: "apply",
    value: function apply() {
      var themeBuilder = elementorTenweb.modules.themeBuilder;
  ...
  (0, _createClass2.default)(ThemeBuilderAddEditorUI, [{
    ...
    value: function addPublishTabs() {
      ...
      component.addTab('conditions', {
        title: elementorTenweb.translate('conditions'),
        View: _view.default,
        viewOptions: {
        ...
        name: 'conditions',
        description: elementorTenweb.translate('conditions_publish_screen_description'),
        image: elementorTenweb.config.urls.modules + 'theme-builder/assets/images/conditions-tab.svg'
      });
    }
  }, {
    key: "addPanelFooterSubmenuItems",
    value: function addPanelFooterSubmenuItems() {
      ...
      footerView.ui.menuConditions = footerView.addSubMenuItem('saver-options', {
        ...
        name: 'conditions',
        icon: 'eicon-flow',
        title: elementorTenweb.translate('display_conditions'),
        callback: function callback() {
    ...
    value: function onPageStatusChange(newStatus) {
      ...
      var options = {
        ...
        buttons: [{
          ...
          text: '<i class="eicon-external-link-square"></i><span class="e-theme-builder-toaster-button-text">' + elementorTenweb.translate('open_site_editor') + '</span>',
          callback: function callback() {
            $e.run('app/open');
          }
        }, {
          name: 'view_live_site',
          text: '<i class="eicon-preview-medium"></i><span class="e-theme-builder-toaster-button-text">' + elementorTenweb.translate('view_live_site') + '</span>',
          callback: function callback() {
...
var ThemeBuilderModule = /*#__PURE__*/function (_elementorModules$edi) {
  ...
  (0, _createClass2.default)(ThemeBuilderModule, [{
    ...
    value: function __construct() {
      ...
      (0, _defineProperty.default)(elementorTenweb.config, 'theme_builder', {
        get: function get() {
...
var _default = /*#__PURE__*/function (_elementorModules$com) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function getLogoOptions() {
      return {
        title: elementorTenweb.translate('publish_settings')
      };
    }
  }, {
    key: "initModal",
    value: function initModal() {
      ...
      this.modal.addButton({
        name: 'publish',
        text: elementorTenweb.translate('save_and_close'),
        callback: function callback() {
      ...
      this.modal.addButton({
        name: 'next',
        text: elementorTenweb.translate('next'),
        callback: function callback() {
...
var ElementorTenweb = Marionette.Application.extend({
  config: {},
  modules: {},
  initModules: function initModules() {
    ...
    if ( elementorTenwebEditorConfig.global_widget_is_active ) {
      this.modules['globalWidget'] = new _module2.default();
      this.modules['queryControl'] = new QueryControl();
      this.modules['library'] = new Library();
      this.modules['customCSS'] = new _editor.default();
      this.modules['motionFX'] = new _editor2.default();
  ...
  onStart: function onStart() {
    ...
    this.config = elementorTenwebEditorConfig;
    this.initModules();
  ...
  onElementorInit: function onElementorInit() {
    ...
    elementorTenweb.libraryRemoveGetProButtons();
    elementorCommon.debug.addURLToWatch('tenweb-builder/pro-features/assets');
  },
  onElementorPreviewLoaded: function onElementorPreviewLoaded() {
    elementor.$preview[0].contentWindow.elementorTenweb = this;
  },
  ...
  onActivateSuccess: function onActivateSuccess() {
    ...
    elementorTenweb.config.isActive = true;
...
window.elementorTenweb = new ElementorTenweb();
elementorTenweb.start();
})();

  ...
  (0, _createClass2.default)(CustomIcons, [{
    ...
    value: function getDefaultSettings() {
      return {
        ...
        notice: ElementorTenwebConfig.i18n.fontsUploadEmptyNotice
      };
    }
  }, {
...
module.exports = function () {
  ...
  self.cacheElements = function () {
    this.cache = {
      $button: jQuery('#tenweb_builder_typekit_validate_button'),
  ...
  self.fetchFonts = function () {
    ...
    jQuery.post(ajaxurl, {
      action: 'tenweb_builder_admin_fetch_fonts',
      kit_id: kitID,
...
module.exports = function () {
  ...
  self.init = function () {
    jQuery(document).on('change', '.elementor-widget-template-select', function () {
      ...
      var editUrl = ElementorTenwebConfig.i18n.home_url + '?p=' + templateID + '&elementor';
